...
data_ndvi<-data.frame(start_date,data) %>% 
  mutate(mes=substr(start_date,6,7), ano=substr(start_date,1,4)) %>%
  group_by(ano,mes) %>% summarise(ndvi = mean(data, na.rm = T))
...
#### **5.4.2. Variabilidad de incendios por altitud**
...
Como podemos observar en el histograma los incendios se registran entre los 1000 y 3000 msnm, pero es entre los 1750 y 2300 principalmente donde la cantidad de incendios supera los 10 registros aproximadamente.


#### **5.4.3. Poligonizamos el DEM: Clases de altitud**
...
#### **5.4.4. Variabilidad estacional de precipitación por elevación**
...
#### **5.4.5. Variabilidad estacional de temperatura máxima por elevación**
