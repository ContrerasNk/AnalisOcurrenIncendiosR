...
### 5.3 Análisis de variables: Análisis de comportamiento estacional de variables bioclimáticas por rangos de elevación
...
Map$addLayer(Cutervo_dem,visParams = viz, name = "DEM_SRTM_V4") +
...
#### 5.3.2. Poligonizamos el DEM: Clases de altitud
...
#### 5.3.2. Variabilidad estacional de precipitación por elevación
...
#### 5.3.2. Variabilidad estacional de temperatura máxima por elevación
