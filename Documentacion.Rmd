...
```{r eval=TRUE, message=FALSE, echo = TRUE, warning=FALSE, cache=FALSE, fig.align='center', fig.cap="Figura 34. Histograma de las anomalías de NDVI mensual promediado sobre el área para el período 2000 - 2017"}
...
```{r eval=TRUE, message=FALSE, echo = TRUE, warning=FALSE, cache=FALSE, fig.align='center', fig.cap= "Figura 35. Histograma de las anomalías de precipitación acumulada mensual promediado sobre el área para el período 2000 - 2017"}
...
área de estudio con un lag máximo de 3 meses, en donde las marcadas con ✇ corresponden a las correlaciones significativas $(p_{value} < 0.05)$ que se dan principalmente en los meses de Abril y Noviembre los valores poseen una correlación positiva principalmente en las correlaciones con lag 0 y 1.
