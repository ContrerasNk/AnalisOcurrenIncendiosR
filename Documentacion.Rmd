...
ggplot(melted_a, aes(pp,ndvi))+ geom_raster(aes(fill=corr)) +
  ...
  geom_text(aes(2, 2, label = "✇"), color = "black", size = 6) + 
  geom_text(aes(3, 3, label = "✇"), color = "black", size = 6) + 
  geom_text(aes(3, 5, label = "✇"), color = "black", size = 6) +
  geom_text(aes(5, 5, label = "✇"), color = "black", size = 6) +
  geom_text(aes(7, 7, label = "✇"), color = "black", size = 6) +
  geom_text(aes(7, 8, label = "✇"), color = "black", size = 6) +
  geom_text(aes(7, 9, label = "✇"), color = "black", size = 6) +
  geom_text(aes(7, 10, label = "✇"), color = "black", size = 6) + 
  geom_text(aes(9, 9, label = "✇"), color = "black", size = 6) + 
  geom_text(aes(9, 9, label = "✇"), color = "black", size = 6) +
  geom_text(aes(11,1, label = "✇"), color = "black", size = 6) +
  geom_text(aes(11, 11, label = "✇"), color = "black", size = 6) +
  geom_text(aes(11, 12, label = "✇"), color = "black", size = 6) 
```
