...
```{r, eval=TRUE, message=FALSE, echo = FALSE, warning=FALSE, cache=FALSE}
pp_velox <- velox("RasterData/PISCO/Prec_monthly/PISCOp_v2.1.1.nc")                 
...
```{r, eval=TRUE, message=FALSE, echo = FALSE, warning=FALSE, cache=FALSE}
temp_velox <- velox("RasterData/PISCO/tmax_monthly/PISCOmtx_v1.1.nc")                 
region <- read_sf("Materiales/Cutervo.gpkg")
...
>>>>>>> 979fd4383183ae977f196020d92bfcc8b63468d2
