...
Aca van los resultados del test de normalidad
...
Por ello, la correlación no paramétrica de Spearman fue aplicada a las variables con un lag máximo de 3 meses, asímismo la correlación aplicada ...

Grafica de correlación rezagada
```{r eval=TRUE, message=FALSE, echo = FALSE, warning=FALSE, cache=FALSE, fig.align='center'}
...
```{r eval=TRUE, message=FALSE, echo = FALSE, warning=FALSE, cache=FALSE, fig.align='center'}
# Heatmap pvalue ------------------------------------------------
ggplot(melted_b, aes(pp,ndvi)) + 
  geom_raster(aes(fill=pvalue<0.05)) +
  ggtitle('Correlación rezagada significativa de Precipitación con NDVI', subtitle = 'De 2000 a 2017') +
  labs(x = 'Anomalía de precipitación acumulada mensual\n[mm/mes]', y = 'Anomalía de NDVI mensual', fill='') +
  theme_bw() +
  theme(plot.title    = element_text(size = 15, hjust = 0.5, face = 'bold'),
        plot.subtitle = element_text(size = 11, hjust = 0.5, face = 'italic'),
...
En esta gráfica se aprecia la correlación de las anomalías de precipitación acumulada mensual con respecto a las anomalías mensuales de NDVI promediadas sobrenuestra área de estudio con un lag máximo de 3 meses. se observan correlaciones significativas (pvalue < 0.05) principalmente en los meses de Julio y Noviembre 
